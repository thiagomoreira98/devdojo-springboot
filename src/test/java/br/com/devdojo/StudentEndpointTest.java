...
//        ResponseEntity<String> exchange = restTemplate.exchange("/v1/admin/students/{id}", HttpMethod.DELETE, null, String.class, 1);
//        Assertions.assertThat(exchange.getStatusCodeValue()).isEqualTo(200);
//    }

    @Test
    @WithMockUser(username = "doesNotExist", password = "xxx", roles = {"USER", "ADMIN"})
...
//        Assertions.assertThat(exchange.getStatusCodeValue()).isEqualTo(404);
    ...
    @Test
    @WithMockUser(username = "doesNotExist", password = "xxx", roles = {"USER"})
